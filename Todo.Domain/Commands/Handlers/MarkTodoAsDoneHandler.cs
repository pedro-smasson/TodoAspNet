...
{
    public class MarkTodoAsDoneHandler : Notifiable<Notification>, IHandler<MarkTodoAsUndoneCommand>
    {
        private readonly ITodoRepository _todoRepository;

        public MarkTodoAsDoneHandler(ITodoRepository todoRepository)
